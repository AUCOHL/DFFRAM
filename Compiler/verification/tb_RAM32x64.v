...
/*
    An auto generated testbench to verify RAM32x64
...
module tb_RAM32x64;
    ...
    RAM32 #(.USE_LATCH(`USE_LATCH), .WSIZE(SIZE)) SRAM (
        .CLK(CLK),
        .WE(WE),
        .EN(EN),
        .Di(Di),
    ...
    initial begin
        $dumpfile("tb_RAM32x64.vcd");
        $dumpvars(0, tb_RAM32x64);
        @(done) $finish;
    end
