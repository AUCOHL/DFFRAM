...
cp $PDK_ROOT/sky130/sky130A/libs.ref/sky130_fd_sc_hd/sky130_fd_sc_hd.merged.lef ./example_support # Requires handmerge
cp $PDK_ROOT/sky130/sky130A/libs.tech/magic/sky130A.magicrc ./example_support 
